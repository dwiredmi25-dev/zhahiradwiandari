...
<body class="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 min-h-screen px-6 py-10 overflow-x-hidden relative">
    ...
    <div data-aos="zoom-in"
        ...
        <div class="grid md:grid-cols-2 items-center">
            ...
            <!-- RIGHT -->
            <div class="relative hidden md:flex items-center justify-center p-10">

                <!-- Glow -->
                <div class="absolute w-96 h-96 bg-cyan-400 rounded-full blur-3xl opacity-30 animate-pulse"></div>

                <!-- Circle Border -->
                <div class="absolute w-87.5 h-87.5 border border-cyan-400/30 rounded-full animate-spin"
                    style="animation-duration: 15s;">
                </div>

                <div class="absolute w-105 h-105 border border-blue-400/20 rounded-full animate-spin"
                ...
                <img src="profile.jpeg"
                    alt="Profile"
                    data-aos="fade-left"
                    class="relative w-80 rounded-[35px] border-4 border-white/20 shadow-2xl floating glow hover:scale-105 duration-500 z-10">
